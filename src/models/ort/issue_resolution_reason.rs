...
/// Possible reasons for resolving an issue using an [`crate::models::ort::issue_resolution::IssueResolution`].
...
crate::models::ort::validated_int_enum::validated_int_enum!(IssueResolutionReason {
